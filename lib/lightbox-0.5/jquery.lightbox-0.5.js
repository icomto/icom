...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/lib/lightbox-0.5/ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/lib/lightbox-0.5/btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/lib/lightbox-0.5/btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'/lib/lightbox-0.5/btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'/lib/lightbox-0.5/blank.gif',			// (string) Path and the name of a blank image (one pixel)
