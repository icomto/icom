...
class _HWLDF_WordAccumulator {
  ...
  function _flushGroup ($new_tag) {
    if ($this->_group !== '') {
    if ($this->_tag == 'mark')
      $this->_line .= '<span class="diff-changed">'.$this->_group.'</span>';
    else
...
class TableDiffFormatter extends DiffFormatter
{
  ...
  function _block_header( $xbeg, $xlen, $ybeg, $ylen ) {
    $r = '<tr><td class="diff-blockheader" colspan="2">Zeile '.$xbeg."</td>\n" .
      '<td class="diff-blockheader" colspan="2">Zeile '.$ybeg."</td></tr>\n";
    return $r;
  }
  ...
  function addedLine( $line ) {
    ...
    return '<td class="diff-a">+</td><td class="diff-addedline">' .
      $line.'</td>';
  }
  ...
  function deletedLine( $line ) {
    $line = str_replace('  ',' &nbsp;',$line);
    #if($line{0} == ' ') $line = '&nbsp;'.substr($line,1);
    return '<td class="diff-a">-</td><td class="diff-deletedline">' .
      $line.'</td>';
  }
  ...
  function contextLine( $line ) {
    $line = str_replace('  ',' &nbsp;',$line);
    #if($line{0} == ' ') $line = '&nbsp;'.substr($line,1);
    return '<td class="diff-a"> </td><td class="diff-context">'.$line.'</td>';
  }
