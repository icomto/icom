<?php require_once '../config.inc.php'; session::start(); ?>
...
if (!empty($_POST['captcha'])) {
    if (!isset(session::$s['captcha']) || trim(strtolower($_POST['captcha'])) != session::$s['captcha']) {
